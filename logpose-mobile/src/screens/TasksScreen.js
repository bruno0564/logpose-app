...
const makeStyles = (t) => StyleSheet.create({
  ...
  title:           { color: t.cartoon ? t.accent : t.text, fontSize: 22, fontWeight: '700', flex: 1, marginHorizontal: 8, fontFamily: t.fontTitle, textTransform: t.cartoon ? 'uppercase' : 'none', ...titleShadow(t) },
